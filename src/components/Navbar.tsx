      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/#about" className="link-underline text-portfolio-dark hover:text-portfolio-purple">About</Link>
            <Link to="/#projects" className="link-underline text-portfolio-dark hover:text-portfolio-purple">Projects</Link>
            <Link to="/#services" className="link-underline text-portfolio-dark hover:text-portfolio-purple">Services</Link>
            <Link to="/#testimonials" className="link-underline text-portfolio-dark hover:text-portfolio-purple">Testimonials</Link>
            <Link to="/#contact">
