    ...
    <section id="projects" className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-gradient text-3xl md:text-4xl font-bold mb-4">My Projects</h2>
        ...
        <div className="text-center mt-12">
          <Button 
            className="group bg-gradient-to-r from-portfolio-purple to-portfolio-blue flex items-center gap-2"
